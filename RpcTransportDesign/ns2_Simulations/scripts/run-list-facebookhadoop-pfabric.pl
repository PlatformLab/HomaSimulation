...
@load = (0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.8, 0.85);
...
$work_dir = "/scratch/behnamm/pfabric/rc32/work_dir";
###########################################
# ns source code server
$ns_source_server = "rc32";
# ns source code path
...
$log_server = "rcmaster";
$log_dir = "/scratch/behnamm/pfabric/rc32/logs";
...
`ssh $user\@$log_server 'mv $log_dir/logs $log_dir/$mon$mday-hadoop-pfabric'`;

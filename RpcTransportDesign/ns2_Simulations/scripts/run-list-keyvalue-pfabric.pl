...
###########################################
$tcl_script = "empirical_keyvalue_pfabric";
$work_dir = "/scratch/behnamm/pfabric/rcmonster/work_dir";
###########################################
# ns source code server
$ns_source_server = "rcmonster";
# ns source code path
...
`ssh $user\@$log_server 'mv $log_dir/logs $log_dir/$mon$mday-keyvalue-pfabric'`;

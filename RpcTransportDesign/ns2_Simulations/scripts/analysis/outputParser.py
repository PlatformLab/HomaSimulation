...
if __name__ == '__main__':
    flowFile = os.environ['HOME'] + '/Research/RpcTransportDesign/ns2_Simulations/logs/1028-heavymiddle-pfabric/008-empirical_heavymiddle_pfabric-s16-x1-q24-load0.8-avesize2567.292-mp0-DCTCP-Sack-ar1-SSRtrue-DropTail10000-minrto4.5e-05-droptrue-prio2-dqtrue-prob5-kotrue/flow.tr'
    fd = open(flowFile)
    stretchs = dict()
    N = 0.0
    B = 0.0

...
stretchVsSize <- read.table("stretchVsTransport_homa_pfabric_phost.txt", na.strings = "NA",
...
workloads <- c(levels(avgStretchVsSize$WorkLoad)[3],levels(avgStretchVsSize$WorkLoad)[5],levels(avgStretchVsSize$WorkLoad)[1],
 levels(avgStretchVsSize$WorkLoad)[4],levels(avgStretchVsSize$WorkLoad)[2])

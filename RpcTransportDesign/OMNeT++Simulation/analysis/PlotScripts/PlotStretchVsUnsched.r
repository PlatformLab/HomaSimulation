...
pdf("MeanStretchVsUnsched.pdf", width=65, height=90)
ggplot(avgStretchVsUnsched, aes(x=UnschedBytes, y=MeanStretch)) + 
    ...
    theme(text = element_text(size=40, face="bold"), axis.text.x = element_text(angle=75, vjust=0.5),
...
pdf("MedianStretchVsUnsched.pdf", width=65, height=90)
...
pdf("TailStretchVsUnsched.pdf", width=65, height=90)
